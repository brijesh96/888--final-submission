...
dataFrame = pd.DataFrame(data=IrisDataset.data, columns=IrisDataset.feature_names)
dataFrame['target'] = IrisDataset.target
print("Iris Dataset:")
...
viz = dtreeviz(dtree,
               ...
               class_names=IrisDataset.target_names.tolist()
              )
viz.view()
