...
dataFrame = pd.DataFrame(data=WineDataset.data, columns=WineDataset.feature_names)
dataFrame['target'] = WineDataset.target
print("Wine  Dataset:")
...
viz = dtreeviz(dtree,
               ...
               class_names=WineDataset.target_names.tolist()
              )
viz.view()
